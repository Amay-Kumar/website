...
function btnClicked() {
  ...
  if (answer1 == "new dehli") {
    ...
    document.getElementById(
      "out1"
    ).innerHTML = `Incorrect! The correct answer is New Dehli`;
    result1 = 0;
  }
  ...
  if (answer3 == "gandhi") {
    ...
    document.getElementById(
      "out3"
    ).innerHTML = `Incorrect! The correct answer is Gandhi`;
    result3 = 0;
  }

  if (answer4 == "twenty eight" || answer4 == "28" || answer4 == "xxvii") {
